...
public class PasswordTest {
    ...
    @Test
    @Points("while-loop-1.2")
    public void askWrongName() {
        io.setSysIn("boot\nfish\ndijkstra\n");
        ...
        assertTrue("Program should keep asking the password until it is given correctly", lastLine.contains(":"));
    }
