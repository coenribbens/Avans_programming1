...
public class SmartCombiningTest {
    ...
    public void tarkistaLista(ArrayList<Integer> origList1, ArrayList<Integer> origList2) {
        ...
        ArrayList<Integer> list1 = new ArrayList<>(origList1);
        ArrayList<Integer> list2 = new ArrayList<>(origList2);
        ...
        ArrayList<Integer> yhdiste = new ArrayList<>(list1);
